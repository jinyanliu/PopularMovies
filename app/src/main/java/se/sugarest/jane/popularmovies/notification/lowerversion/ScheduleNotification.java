...
public class ScheduleNotification {
    ...
    private static final int NOTIFICATION_FLEXTIME_MINUTES = 5;
    private static final int NOTIFICATION_INTERVAL_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(NOTIFICATION_INTERVAL_MINUTES));
    private static final int NOTIFICATION_FLEXTIME_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(NOTIFICATION_FLEXTIME_MINUTES));
