...
public class FetchExternalStoragePopMoviePosterImagesTask extends AsyncTask<MovieBasicInfo, Void, String> {
    ...
    protected String doInBackground(MovieBasicInfo... params) {
        ...
        try {
            ...
            File file = new File(ExternalPathUtils.getExternalPathBasicFileName(this.context) + "/popularmovies/" + filename);
    ...
    protected void onPostExecute(String s) {
        if (s != null) {
            Log.i(TAG, "Insert external poster path: " + s + " into cache popular movie folder successful.");
        } else {
